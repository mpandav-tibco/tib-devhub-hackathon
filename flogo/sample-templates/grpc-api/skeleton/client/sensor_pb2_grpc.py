...
class SensorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SendTelemetryData = channel.unary_unary(
                '/sensors.SensorService/SendTelemetryData',
...
class SensorServiceServicer(object):
    ...
    def SendTelemetryData(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_SensorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendTelemetryData': grpc.unary_unary_rpc_method_handler(
                    servicer.SendTelemetryData,
